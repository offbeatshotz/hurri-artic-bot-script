...
from char.hurridruid import hurridruid
...
class Bot:
    def __init__(self):
        ...
        elif self._config.char["type"] == "hurridruid":
            self._char: IChar = hurridruid(self._config.hurridruid, self._config.char, self._screen, self._template_finder, self._ui_manager, self._pather)
        else:
